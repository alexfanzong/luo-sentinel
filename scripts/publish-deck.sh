...
# This script mirrors the two source decks onto gh-pages, rewriting absolute
# asset paths and the language-toggle links to be site-relative for the
# project-pages base path (/luo-sentinel/).
#
...
git -C "$WORKTREE" add index.html deck.html deck.en.html
