...
export const RWA_EVIDENCE = Object.freeze([
  ...
  },
  {
    ...
    title: "Singapore",
    signal: "Conditional",
    detail: "Start with SFA capital-markets-product classification before mapping any offer route.",
    summary:
      "The official SFA anchor supports a capital markets product and Part 13 offer-path review, but it does not itself resolve whether this token is a CMP or which prospectus or exemption route applies. Treat Singapore as conditional until counsel ties the product facts to exact provisions.",
    sourceLabel: "Singapore Statutes Online · Securities and Futures Act 2001",
  ...
  },
  {
    ...
    summary:
      "MiCA Article 2(4)(a) excludes crypto-assets that qualify as financial instruments; MiFID II Article 4(1)(15) points to Annex I Section C for that assessment. The current demo pack does not establish an OUSG-specific classification, so a MiFID II and local-law review remains required.",
    sourceLabel: "EU · MiCA Article 2(4)(a)",
    sourceUrl: "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32023R1114#d1e1202-40-1",
    secondarySourceLabel: "EU · MiFID II Article 4(1)(15)",
    secondarySourceUrl: "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32014L0065#d1e2078-349-1",
    tone: "blue",
