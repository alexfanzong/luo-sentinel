...
The prototype does not move assets, make legal determinations, connect a
wallet, or transmit a private key. `Prepare testnet receipt` currently creates
only a local draft. The verified Injective integration boundary is documented
in [docs/INJECTIVE_INTEGRATION.md](./docs/INJECTIVE_INTEGRATION.md).
...
- [ ] Verified Injective testnet browser-wallet action
- [ ] Deployed demo URL
